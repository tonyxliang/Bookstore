...
if (!isset($_SESSION['userID'])) {
    header("Location: login.php?user=loginrequired");
    exit();
}
...
?>
        ...
        <div class="banner">
            ...
            <h1 class="homePageText">Check Out</h1>
            <br>
            <br>
        ...
        <!--        <form id="first_form" method="post"> -->
                  ...
                  <fieldset class="first_fieldset">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="includes/update-cart.inc.php" method="post">
                            <button type="submit" name="update-cart"> Update </button>
                          </form>
                        </td>
                        <td>
                          <form action="includes/removeitem.inc.php" method="post">
                            <button type="submit" name="removeitem-cart"> Remove </button>
                          </form>
                        </td>
                      </tr>
                    ...
                    <tr>
                      <td></td>
                      <td> <b>Total Price: $<?php echo $totalprice; ?> </b></td>
                    </tr>
                    </table>
                  </fieldset>
    ...
    <form action="submit-order.inc.php" method="post">
      <section class="shipping">
        <?php
        $userID = $_SESSION['userID'];

        //select user from db for user info fill
        ...
        //select user from db for address fill
        ...
        <form id="second_form" method="post">
          <fieldset class="second_fieldset">
            ...
            <input type="text" value="<?php echo $firstName; ?>"> <br>
            <label> Last Name: </label>
            <input type="text" value="<?php echo $lastName; ?>"> <br>
            <label> Street Address: </label>
            <input type="text" value="<?php echo $address; ?>"><br>
            <label> Building/Apt/Suite: </label>
            <input type="text" value="" placeholder="<?php echo $address2; ?>"> <br>
            <label> City: </label>
            <input type="text" value="<?php echo $city; ?>"><br>
            <label> State: </label>
            <input type="text" value="<?php echo $state; ?>"><br>
            <label> Postal Code: </label>
            <input type="text" value="<?php echo $zipcode; ?>"><br>
            <label> Phone Number: </label>
            <input type="tel" value="<?php echo $phone; ?>"><br>
        ...
        $fullName = trim($row['cardFullName']);
        $expireDate = trim($row['expiryDate']);

        ?>
        <section class="personal">
            <h4> Payment Information</h4>
            <form id="third_form" action="includes/submit-order.inc.php" method="post">
              <fieldset class="third_fieldset">
                <label> Full Name: </label>
                <input type="text" name="ccFullName" value="<?php echo $fullName; ?>"> <br>
                <label> Credit Card Number: </label>
                <input type="password" name="ccNumber" placeholder=""> <br>
                <label> Expiration: </label>
                <input type="date" name="expireDate" value="<?php echo $expireDate; ?>"> <br>
                <label> CVC: </label>
                <input type="password" name="cvcNum" placeholder=""> <br><br>
                <label> Promotional Code: </label>
                <input type="text" name="promo" placeholder="Promo"> <br>
                      <button type="submit" name="submit-order" style="margin-right: 80%;" class="center-block" > Submit Order </button>
                ...
                <input type="hidden" value="<?php echo $address2; ?>" name="address2"/>
